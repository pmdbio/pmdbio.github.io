...
knitr::include_graphics("../_images/engrenagem.png")
```

```{r, out.width="900px", echo=FALSE}
knitr::include_graphics("../_images/engrenagem2.png")
```
...
```{r echo=11:14, fig.width=15, fig.height=5}
# Preparando margens do ambiente gráfico
par(mar = c(13, 5, 2, 2))
...
```{r echo=15:29, fig.width=15, fig.height=5}
# Preparando margens do ambiente gráfico
par(mar = c(13, 5, 2, 2))
